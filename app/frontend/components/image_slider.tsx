...
const ImageSlider: React.FC<Props> = ({
  ...
  return (
        ...
        <div className="overflow-hidden relative mb-1">
          {lslides.length > 0 && <div className="overflow-hidden relative">
            <div className="w-full overflow-hidden text-center select-none transition-all">
              <div className="w-64 h-64 border rounded-full mx-auto mb-10 overflow-hidden bg-cover bg-center hover:cursor-pointer" onClick={handleFullImageClick}>
                <Image src={lslides[active].img} alt={lslides[active].title} height={300} width={300} />
              </div>
    ...
    {
      popup && <div className=" fixed w-full h-full top-0 left-0 bg-gray-800 z-40 overflow-x-hidden flex flex-col align-center justify-center items-center">
        <div className=" fixed w-full h-full top-0 left-0 overflow-x-hidden flex justify-between items-center p-10">
          <div className="text-white hover:bg-white hover:text-black p-2 rounded hover:cursor-pointer" onClick={handlePreviousClick}>Previous</div>
          <div className="text-white hover:bg-white hover:text-black p-2 rounded hover:cursor-pointer" onClick={handleNextClick}>Next</div>
        </div>  
        <div
        ...
        <img src={lslides[active].img} alt={lslides[active].title} className="h-4/5"/>
        <div>
